...
AlomawaniUI improve the default tradeskill UI. His major feature allow the player to hide a recipe in the tradeskill UI.
...
For more documentation, take a look at the [wiki](https://github.com/lamboley/AlomawaniUI/wiki) page.
...
* If you found a bug or have an error, you can create an issue on [github](https://github.com/lamboley/AlomawaniUI/issues).
